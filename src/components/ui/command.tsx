...
function CommandDialog({
  ...
  return (
    <Dialog {...props}>
      ...
      >
        {/* latent bug fix: children MUST sit inside a <Command> root or
            cmdk consumers (Input/List/Group/Item) render without the store
            context and crash on undefined.subscribe. */}
